...
using pruebadetalle2.Models;

namespace pruebadetalle2.Controllers
{
    public class FacturaVentasController : Controller
    {
        private readonly Practica20240306DBContext _context;

        public FacturaVentasController(Practica20240306DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.FacturaVentas != null ? 
                          ...
                          Problem("Entity set 'Practica20240306DBContext.FacturaVentas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Practica20240306DBContext.FacturaVentas'  is null.");
            }
